---
title: "Homework 3 - Cancer Detection for Michigan Medicine"
author: "Yufei Quan"
output:
  html_document:
    theme: cerulean
...
<span style="font-size:18px">**The patient data shows strong potential for cancer detection when combined with unsupervised learning methodologies such as clustering and outlier detection, although limitations and cautions are still present**</span>
